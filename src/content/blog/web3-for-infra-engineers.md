---
title: 'Web3 Is Just Infrastructure With a Hoodie'
excerpt: Everything in Web3 is something you already know. Wallet signing is SSH authentication v2, smart contracts are RPC endpoints with public immutable code, and the trust model is the same "verify, don't trust" principle that drives every good infrastructure system.
