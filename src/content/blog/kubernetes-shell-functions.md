...
excerpt: A collection of useful shell functions and aliases for Kubernetes debugging and daily operations, from context switching to JWT decoding to Prometheus config extraction.
publishDate: 'Dec 29 2025'
tags:
  - Kubernetes
  - Shell
isFeatured: false
