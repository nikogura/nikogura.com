---
title: 'Dynamic Binary Toolkit: Tools that automatically keep themselves up to date!'
excerpt: A system for building self-updating command-line tools that automatically download, verify, and replace themselves with the latest version using checksums and GPG signatures.
publishDate: 'Dec 09 2017'
tags:
  - Golang
  - Security
  - Tools
